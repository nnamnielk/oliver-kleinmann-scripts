...
def get_event_color(event):
    ...
    elif "rest or light activity" in event_lower:
        return COLORS["green"]
...
schedule = [
    ...
    ("Lunch", 30, "11:45"),                       # Starts at 11:45, ends at 12:15
    ("Workout or Study Session 3", 120, "12:15"), # Starts at 12:15, ends at 14:15
    ("Nap", 30, "14:15"),                         # Starts at 14:15, ends at 14:45
    ("Study Session 4", 120, "14:45"),            # Starts at 14:45, ends at 16:45
    ("Workout or Study Session 5", 90, "16:45"),  # Starts at 16:45, ends at 18:15
    ("Dinner", 30, "18:15"),                      # Starts at 18:15, ends at 18:45
    ("Study Session 6", 120, "18:45"),                 # Starts at 20:45, ends at 21:15
    ("Wind Down", 30, "21:15"),                # Starts at 21:15, ends at 21:45
    ("Anki Cards", 30, "21:45")                    # Starts at 21:45, ends at 22:15
]
